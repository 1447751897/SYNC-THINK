...
export type ComposerGoalState = 'active' | 'paused' | 'blocked' | 'achieved' | 'cleared';

export interface ComposerGoalStatus {
  condition: string;
  status: ComposerGoalState;
  turnCount: number;
