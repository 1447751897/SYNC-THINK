...
import { AUTHOR_SKILL_MARKET_CATALOG } from '@sync-think/protocol/skill-market-catalog';
import {
...
const AUTHOR_SKILL_PACKAGES: readonly AuthorSkillPackage[] = [
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['project-bootstrap'],
    files: {
      'SKILL.md': skillMd({
...
`,
  ...
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['automation-workflow'],
    files: {
      'SKILL.md': skillMd({
...
`,
  ...
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['frontend-design'],
    files: {
      'SKILL.md': skillMd({
...
`,
  ...
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['web-to-markdown'],
    files: {
      'SKILL.md': skillMd({
...
`,
  ...
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['data-insight'],
    files: {
      'SKILL.md': skillMd({
        slug: 'data-insight',
...
`,
  ...
  {
    ...AUTHOR_SKILL_MARKET_CATALOG['publish-x'],
    files: {
      'SKILL.md': skillMd({
        slug: 'publish-x',
